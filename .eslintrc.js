...
// If you build a library around `@temp-mui/material` you can safely use `createStyles` without running into the same issue as we are.
      ...
      rules: {
        'no-restricted-imports': [
          'error',
          {
            paths: [
              {
                name: '@temp-mui/material/styles',
                importNames: ['createStyles'],
                message: forbidCreateStylesMessage,
              },
              {
                name: '@temp-mui/styles',
                importNames: ['createStyles'],
                message: forbidCreateStylesMessage,
              },
              {
                name: '@temp-mui/styles/createStyles',
                message: forbidCreateStylesMessage,
              },
            ],
            patterns: [
