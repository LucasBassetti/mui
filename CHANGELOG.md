...
- &#8203;<!-- 22 -->[code-infra] Rename @temp-mui-internal/docs-utils to @temp-mui/internal-docs-utils (#41498) @michaldudak
- &#8203;<!-- 21 -->[code-infra] Copy translations.json to @temp-mui/docs build folder (#41472) @Janpot
...
- &#8203;<!-- 17 -->Remove unused dev dependency on @temp-mui/lab (#41198) @brijeshb42
- &#8203;<!-- 15 -->[Slider] Deprecate components and componentProps props for v6 (#40777) @lhilgert9

### `@temp-mui/system@5.15.12`
...
- &#8203;<!-- 04 -->[zero] Move extendTheme to already existing @temp-mui/zero-runtime/utils (#41254) @brijeshb42
...
- &#8203;<!-- 40 -->[code-infra] Embed translations in the @temp-mui/docs package (#41246) @Janpot
...
- [changelog] Remove @temp-mui/system@5.15.10 (#41093) @michaldudak
- [code-infra] Move typescript-to-proptypes to internal-scripts package (#41079) @michaldudak
- [code-infra] Move Link to @temp-mui/docs (#40889) @Janpot
...
- [core][base-ui] Remove `@temp-mui/base` dev dependency from Base UI workspace (#41216) @ZeeshanTamboli
...
- 🐛 A critical fix to remove non-published library usage in `@temp-mui/material` peerDependencies.

### `@temp-mui/material@5.15.9`
...
- &#8203;<!-- 25 -->[code-infra] Prepare publishing @temp-mui-internal/typescript-to-proptypes to npm (#40842) @michaldudak
...
- &#8203;<!-- 20 -->[code-infra] Remove unnecessary @temp-mui/utils dependency from api-docs-builder (#40632) @michaldudak
...
### `@temp-mui/material-next@6.0.0-alpha.118`

- &#8203;<!-- 36 -->[ButtonGroup] Apply MD3 style to `ButtonGroup` (#40124) @lhilgert9

### `@temp-mui/base@5.0.0-beta.32`
...
### `@temp-mui/codemod@5.15.5`

- &#8203;<!-- 31 -->Allow `json` files to be transformed (#40536) @ZeeshanTamboli

### `@temp-mui/lab@5.0.0-alpha.161`

- &#8203;<!-- 09 -->Update `@temp-mui/material` peer dependency version (#40528) @ZeeshanTamboli

### `@temp-mui/material-nextjs@5.15.5`

- &#8203;<!-- 08 -->Fix release script (#40519) @petrovmiroslav
- &#8203;<!-- 07 -->Support Nonces in the App Router Provider (#40269) @josh-feldman
- &#8203;<!-- 06 -->Polish @temp-mui/material-nextjs (#40473) @oliviertassinari

### `@temp-mui/system@5.15.5`

- &#8203;<!-- 05 -->Fix import path for @temp-mui/system in vite apps (#40490) @brijeshb42
...
- &#8203;<!-- 36 -->[code-infra] Break package dependency cycle between @temp-mui/material and @temp-mui/icons-material (#40400) @michaldudak
...
### `@temp-mui/material-next@6.0.0-alpha.115`
...
### `@temp-mui/styled-engine-sc@6.0.0-alpha.9`
...
### `@temp-mui/material-nextjs@5.15.0`

- &#8203;<!-- 01 -->[material-ui] Add new Next.js integration package (#39947) @siriwatknp

### `@temp-mui/material-next@6.0.0-alpha.113`
...
### `@temp-mui/material-next@6.0.0-alpha.112`
...
### `@temp-mui/material-next@6.0.0-alpha.110`
...
### `@temp-mui/material-next@6.0.0-alpha.108`
...
- &#8203;<!-- 13 -->[system] Clean up `@temp-mui/styles` docs and discourage users from installing it (#39644) @samuelsycamore
...
### `@temp-mui/material-next@6.0.0-alpha.107`
...
### `@temp-mui/lab@5.0.0-alpha.150`

- &#8203;<!-- 09 -->Update peer dep of @temp-mui/material (#39398) @brijeshb42

### `@pigment-css/react@0.0.1-alpha.0`

- &#8203;<!-- 06 -->Implement typings for public runtime API (#39215) @brijeshb42

### `@temp-mui/zero-vite-plugin@0.0.1-alpha.0`
...
### `@temp-mui/base@5.0.0-beta.19`

- [Menu] Add the anchor prop (#39297) @michaldudak

### `@temp-mui/material-next@6.0.0-alpha.105`

- [Menu] Copy v5 Menu components (#39301) @mnajdova

### `@temp-mui/joy@5.0.0-beta.10`
...
### `@temp-mui/styled-engine-sc@6.0.0-alpha.1`
...
### `@temp-mui/material-next@6.0.0-alpha.104`
...
### `@temp-mui/utils@5.14.11`

- Support RSC in `isMuiElement` util (#38129) @sai6855

### `@temp-mui/base@5.0.0-beta.17`
...
### `@temp-mui/material-next@6.0.0-alpha.103`

- [FormControl] Copy v5 FormControl (#39039) @mj12albert

### `@temp-mui/lab@5.0.0-alpha.146`
...
- &#8203;<!-- 18 -->[core] Allow deeper import of @temp-mui/utils (#38806) @oliviertassinari
- &#8203;<!-- 17 -->[core] Remove react-dom from @temp-mui/utils peerDependencies (#38974) @michaldudak
...
### `@temp-mui/lab@5.0.0-alpha.144`

- &#8203;<!-- 09 -->Add TypeScript deprecations (#38833) @oliviertassinari
- &#8203;<!-- 08 -->Fix `@temp-mui/x-tree-view` dependency (#38822) @flaviendelangle

### `@temp-mui/system@5.14.9`
...
### `@temp-mui/base@5.0.0-beta.12`

- [Popup] New component (#37960) @michaldudak

### `@temp-mui/joy@5.0.0-beta.3`
...
### `@temp-mui/material-next@6.0.0-alpha.98`
...
- &#8203;<!-- 32 -->[base] Ban default exports (#38200) @michaldudak
  ...
  ```diff
  - import Button, { buttonClasses } from '@temp-mui/base/Button';
  + import { Button, buttonClasses } from '@temp-mui/base/Button';
  - import BaseMenu from '@temp-mui/base/Menu';
  + import { Menu as BaseMenu } from '@temp-mui/base/Menu';
  ```

  Additionally, the `ClassNameGenerator` has been moved to the directory matching its name:

  ```diff
  - import ClassNameGenerator from '@temp-mui/base/className';
  + import { ClassNameGenerator } from '@temp-mui/base/ClassNameGenerator';
  ```

  A codemod is provided to help with the migration:

  ```bash
  npx @temp-mui/codemod@latest v5.0.0/base-use-named-exports <path>
  ```
...
### `@temp-mui/joy@5.0.0-beta.0`

- &#8203;<!-- 10 -->[joy] Refine the default theme (#36843) @siriwatknp

### `@temp-mui/material-next@6.0.0-alpha.95`
...
### `@temp-mui/material-next@6.0.0-alpha.93`
...
- [docs][material] Rename custom tab panel in Tabs demo to prevent confusion with @temp-mui/lab (#37638) @MUK-Dev
...
### `@temp-mui/utils@5.13.2`

- &#8203;<!-- 04 -->[utils] Allow nested imports in @temp-mui/utils to speed up build (#37586) @flaviendelangle
...
- The `component` prop is no longer supported because it can be replaced with the slots API. This is how the transformation will look like:
  ...
  ```bash
  npx @temp-mui/codemod@latest v5.0.0/base-remove-component-prop <path>
  ```
...
- &#8203;<!-- 27 -->[base] Remove unstyled suffix from Base components + Codemod script (#36873) @hbjORbj
  ...
  ```bash
  npx @temp-mui/codemod@latest v5.0.0/base-remove-unstyled-suffix <path>
  ```
...
### `@temp-mui/icons-material@5.11.16`

- [icons] Do not ignore popular icons (#36608) @michaldudak

### `@temp-mui/joy@5.0.0-alpha.74`
...
- &#8203;<!-- 27 -->[Select][base] Add the multiselect functionality to SelectUnstyled (#36274) @michaldudak
  ...
  ```diff
  -import MultiSelectUnstyled from '@temp-mui/base/MultiSelectUnstyled';
  +import SelectUnstyled from '@temp-mui/base/SelectUnstyled';
...
- &#8203;<!-- 18 -->[docs] Fix @temp-mui/styles example links (#36331) @oliviertassinari
...
- &#8203;<!-- 28 -->[base] Move hooks to their own directories (#36235) @hbjORbj
  ...
  ```diff
  -import { useBadge } from '@temp-mui/base/BadgeUnstyled';
  +import useBadge from '@temp-mui/base/useBadge';
  ```
...
### `@temp-mui/material-next@6.0.0-alpha.75`
...
- [docs] Fix typo in the released version of @temp-mui/styled-engine (#36121) @m4theushw
...
### `@temp-mui/system@5.11.8`

- &#8203;<!-- 05 -->[System] Fix nested grid v2 (#35994) @siriwatknp

### `@temp-mui/styled-engine@5.11.8`
...
### `@temp-mui/material-next@6.0.0-alpha.68`
...
- [system] Enable configuring the `sx` prop in the `theme` (#35150) @mnajdova
  ...
  ```diff
  -import { styled, experimental_sx } from '@temp-mui/material/styles';
...
- [core] Fix @temp-mui/material package building (#35324) @timbset
...
### `@temp-mui/system@5.10.14`

- [Unstable_Gridv2] sorted responsize keys based on breakpoint value (#34987) @sai6855

### `@temp-mui/joy@5.0.0-alpha.54`

- [Joy] Export `FormControl`, `LinearProgress` and `ListSubheader` components from `@temp-mui/joy` (#35003) @Studio384
...
### `@temp-mui/base@5.0.0-alpha.101`

- &#8203;<!-- 01 -->[FocusTrap] Restore the previously exported type from @temp-mui/material (#34601) @michaldudak

### `@temp-mui/joy@5.0.0-alpha.49`
...
### `@temp-mui/material@5.0.0-alpha.101`

- [deps] Move @temp-mui/types to dependencies (#34384) @Methuselah96

### `@temp-mui/base@5.0.0-alpha.99`
...
- [FocusTrap] Rename TrapFocus to FocusTrap (#34216) @kabernardes
  ...
  ```diff
  -import TrapFocus from '@temp-mui/base/TrapFocus';
  +import FocusTrap from '@temp-mui/base/FocusTrap';
  ```
...
- [core] Document some types in @temp-mui/styled-engine-sc (#34413) @mnajdova
...
- [docs] Improve the guide for using @temp-mui/base with Tailwind CSS (#33670) @mnajdova
...
- &#8203;<!-- 08 -->[examples] Fix error in Next.js example with @temp-mui/styles (#33456) @paustria
...
- [core] Fix @temp-mui/monorepo regression for the import of the docs infra (#33390) @Janpot
...
- 🚀 Improved the TypeScript augmentation when using CSS variables with `@temp-mui/material`
- many other 🐛 bug fixes and 📚 documentation improvements

### `@temp-mui/material@5.8.6`
...
- &#8203;<!-- 12 -->[examples] Add example using nextjs & @temp-mui/styles as a starter for the migration to v5 (#33005) @mnajdova
...
### `@temp-mui/codemod@5.8.4`

- &#8203;<!-- 35 -->[codemod] Add support for `@temp-mui/styles/makeStyles` imports (#32962) @joshkel

### `@temp-mui/lab@5.0.0-alpha.86`
...
### `@temp-mui/base@5.0.0-alpha.84`

- [base] Remove @temp-mui/system in tests (#32945) @kevinji
...
### `@temp-mui/lab@5.0.0-alpha.83`

- &#8203;<!-- 15 -->[lab] Add missing `peerDependencies` (#32623) @nate-summercook
- &#8203;<!-- 12 -->[pickers] Update @temp-mui/x-date-pickers to be usable with React 18 (#32828) @flaviendelangle

### `@temp-mui/base@5.0.0-alpha.82`

- &#8203;<!-- 08 -->[SliderUnstyled] Fix `disabledSwap` not being respected in `onChangeCommitted` (#32647) @JeanPetrov

### `@temp-mui/joy@5.0.0-alpha.29`
...
- [docs] Cleanup remaining @temp-mui/styles usages (#32313) @mnajdova
...
- [core] Update the proptypes scripts to support components in @temp-mui/system (#32456) @mnajdova
...
- 🚀 Added the experimental `CssVarsProvider` in `@temp-mui/material` for generating theme CSS variables (#31138) @mnajdova
- 📣 Moved date and time pickers from the lab to MUI X (#31984) @flaviendelangle
- Several 🐛 bug fixes and 📚 documentation improvements

### `@temp-mui/material@5.6.0`

- &#8203;<!-- 25 -->[CssVarsProvider] Add experimental CssVarsProvider in @temp-mui/material (#31138) @mnajdova
...
- &#8203;<!-- 28 -->[docs] Add page for CSS variables support in @temp-mui/material (#32050) @mnajdova
...
### `@temp-mui/codemod@5.5.3`

- &#8203;<!-- 31 -->[codemod] Fix variant prop placement (#31990) @ryancogswell

### `@temp-mui/utils@5.5.3`

- &#8203;<!-- 02 -->[utils] Improve type inference of useForkRef (#31845) @eps1lon

### `@temp-mui/base@5.0.0-alpha.74`

#### Breaking changes

- &#8203;<!-- 34 -->[base] Remove `BackdropUnstyled` component (#31923) @mnajdova

  The `BackdropUnstyled` component was removed from the `@temp-mui/base` package, as it did not have any specific logic, except adding an `aria-hidden` attribute on the div it rendered. This is not enough to justify it's existence in the base package. Here is an example alternative component you can use:
...
- &#8203;<!-- 03 -->[FocusTrap] Move docs to Base and drop the Unstyled prefix (#31954) @michaldudak
  ...
  ```diff
  -import { Unstyled_TrapFocus } from '@temp-mui/base';
  +import { TrapFocus } from '@temp-mui/base';

   // or

  -import TrapFocus from '@temp-mui/base/Unstyled_TrapFocus';
  +import TrapFocus from '@temp-mui/base/TrapFocus';
  ```

#### Changes

- &#8203;<!-- 33 -->[base] Add @temp-mui/types to dependencies (#31951) @bicstone

### `@temp-mui/joy@5.0.0-alpha.21`
...
- &#8203;<!-- 24 -->[ClassNameGenerator] Prevent all `base` imports (#31297) @siriwatknp
  ...
  ```diff
  -import { unstable_ClassNameGenerator } from '@temp-mui/material/utils';
  +import { unstable_ClassNameGenerator } from '@temp-mui/material/className';
  ```
...
### `@temp-mui/material-next@6.0.0-alpha.26`

- &#8203;<!-- 06 -->[material-next] Mark @temp-mui/material as a dependency (#31270) @siriwatknp
...
### `@temp-mui/icons-material@5.4.3`

- &#8203;<!-- 11 -->[icons] Add "circle" icon synonyms (#31118) @gnowland

### `@temp-mui/joy@5.0.0-alpha.16`
...
- &#8203;<!-- 26 -->[docs] Fix WithStyles import statement for @temp-mui/styles (#30942) @altruity
...
- &#8203;<!-- 20 -->[docs] Clarify what the name of @temp-mui/material is (#30866) @oliviertassinari
...
### `@temp-mui/material@5.4.0`

#### Breaking changes

- &#8203;<!-- 27 -->[core] Do not reexport Base from Material (#30853) @michaldudak

  All Base components were exported from the `@temp-mui/material` package and treated as stable even though the `@temp-mui/base` package is in development. It could create a lot of confusion if developers start using Base components, depend on them, and demand quality found in "proper" Material components. We admit it was a mistake to reexport these components without marking them as unstable.

  Developers are still encouraged to evaluate the Base components, but they should do so by explicitly installing the `@temp-mui/base` package.

  This is technically a breaking change as it removes a number of components from the `@temp-mui/material` package. However, we believe that removing the components now and potentially breaking the codebases will do less harm than introducing "silent" breaking changes to Base components while continuing reexporting them from `@temp-mui/material`.

  Note: the utility components, such as ClickAwayListener, NoSsr, Portal, and TextareaAutosize continue to be exported from both `@temp-mui/material` and `@temp-mui/base`.

  If you're encountering build errors after upgrading @temp-mui/material, do the following:

  1. Install @temp-mui/base: npm install @temp-mui/base or yarn add @temp-mui/base
  2. Make sure the version of @temp-mui/base match the version of @temp-mui/material
  3. Change the import paths of unstyled components from @temp-mui/material to @temp-mui/base, e.g.:

  ```diff
  -import ButtonUnstyled from '@temp-mui/material/ButtonUnstyled';
  +import ButtonUnstyled from '@temp-mui/base/ButtonUnstyled';
  ```
...
- [docs] Adding peer dependencies explanation on @temp-mui/lab README.md (#30532) @glaucoheitor
...
- [website] Migrate Twitter from @MaterialUI to @temp-mui_hq @oliviertassinari
...
- 🛠 Introduced a new `useBadge` hook in the `@temp-mui/base` package (#30246) @mnajdova
- And more 🐛 bug fixes and 📚 documentation improvements.

### `@temp-mui/material@5.2.6`
...
### `@temp-mui/base@5.0.0-alpha.62`

- &#8203;<!-- 26 -->[BadgeUnstyled] Add useBadge hook (#30246) @mnajdova

### `@temp-mui/joy@5.0.0-alpha.8`
...
- &#8203;<!-- 19 -->[docs] Fix text from material-ui to @temp-mui to reflect v5 name changes (#30393) @pupudu
...
- ✨ We have introduced a new unstyled component in `@temp-mui/base`: `TablePagination` (#29759) @mnajdova
...
### `@temp-mui/utils@5.2.3`

- &#8203;<!-- 03 -->[utils] Add typings for `@temp-mui-material/styles/cssUtils` (#29621) @Semigradsky

### `@temp-mui/icons-material@5.2.1`

- &#8203;<!-- 12 -->[icons] Consolidate ignored icons into one list (#29843) @chao813

### `@temp-mui/base@5.0.0-alpha.59`
...
- &#8203;<!-- 25 -->[docs] Add warning that `@temp-mui/styled-engine-sc` does not work in SSR (#30026) @mnajdova
...
- ♿️ Improved accessibility of `Snackbar` and `TextField` in `@temp-mui/material` (#29782) (#29850) (#29852) @eps1lon.
- 🎉 Added support for `sx` syntax inside `styled()` utility (#29833) @mnajdova.
- 🎉 Added support for more options for `createCssVarsProvider` in `@temp-mui/system` (#29845) (#29857) @hbjORbj.
- And many more 🐛 bug fixes and 📚 improvements.

### `@temp-mui/material@5.2.2`
...
- [core] Ensure `@temp-mui/core` is an alias for `@temp-mui/base` (#29762) @eps1lon
...
- 🛠 Renamed `@temp-mui/core` to `@temp-mui/base` (#29585) @michaldudak.
- And many more 🐛 bug fixes and 📚 improvements.

### `@temp-mui/material@5.1.1`
...
### `@temp-mui/base@5.0.0-alpha.55`

#### Breaking changes

- &#8203;<!-- 27 -->[core] Rename mui/core to mui/base (#29585) @michaldudak

  Based on the results of the [poll](https://twitter.com/michaldudak/status/1452630484706635779) and our internal discussions, we decided to rename the `@temp-mui/core` package to `@temp-mui/base`. The main rationale for this is the fact that we use the term "Core" to refer to the core components product family, the one that includes Material Design components, unstyled components, System utilities, etc. Therefore, @temp-mui/core was effectively a subset of MUI Core. This was confusing.

  The new name better reflects the purpose of the package: it contains unstyled components, hooks, and utilities that serve as a **base** to build on.

  ```diff
  -import { useSwitch } from '@temp-mui/core/SwitchUnstyled';
  +import { useSwitch } from '@temp-mui/base/SwitchUnstyled';
  ```

### `@temp-mui/lab@5.0.0-alpha.55`
...
- 🔧 Fix reported TypeScript issues on the `@temp-mui/system` package because some packages were not released

### `@temp-mui/material@5.0.6`

- &#8203;<!-- 4 -->[Autocomplete] Fix `clearOnBlur` prop (#29208) @hbjORbj
- &#8203;<!-- 2 -->[Rating] Remove z-index from decimal stars (#29295) @williamhaley

### `@temp-mui/system@5.0.6`

- &#8203;<!-- 5 -->[system] Fix various issues reported by using @temp-mui/styled-engine-sc (#29035) @mnajdova
...
- 🧪 Add three components to `@temp-mui/base` by @rebeccahongsf and @hbjORbj.

### `@temp-mui/codemod@5.0.5`

- &#8203;<!-- 38 -->[codemod] Support new package name in `link-underline-hover` transformer (#29214) @siriwatknp

### `@temp-mui/base@5.0.0-alpha.52`
...
### `@temp-mui/system@5.0.5`

- &#8203;<!-- 11 -->[system] Allow function type for `sx` prop (#29198) @hbjORbj
- &#8203;<!-- 10 -->[system] Fix various issues reported by using @temp-mui/styled-engine-sc (#29035) @mnajdova
...
- 🧪 Added `UnstyledInput` and `useInput` hook in the the first component in @temp-mui/base package @michaldudak (#28053)
- 🐛 Fixed many bugs and improved the documentation 📚.

### `@temp-mui/material@5.0.4`
...
- &#8203;<!-- 23 -->[docs] Rename broken package names in docs pointing to `@temp-mui/material` (#29006) @visualfanatic
...
- 🧪 Created the first component in @temp-mui/material-next - our v6 prototype package.
- 🐛 Fixed many bugs and improved the documentation 📚.

### `@temp-mui/material@5.0.3`
...
- &#8203;<!-- 19 -->[framer] Update @temp-mui/\* dependencies (#28469) @eps1lon
...
- &#8203;<!-- 39 -->[core] Create @temp-mui/material-next package (#28200) @michaldudak
...
- 🎉 Renamed packages to `@temp-mui/*` as part of rebranding the company, following the strategy of expanding the library scope beyond Material Design. For more details about it, check the [GitHub discussion](https://github.com/mui/material-ui/discussions/27803).
- 🛠 Added `mui-replace` codemod for migrating `@material-ui/*` to new packages `@temp-mui/*`. Check out this [codemod detail](https://github.com/mui/material-ui/blob/v5.0.0/packages/mui-codemod/README.md#mui-replace) or head to [migration guide](https://mui.com/material-ui/migration/migration-v4/#preset-safe)
...
### `@temp-mui/material@5.0.0-rc.0`

#### Breaking changes

- &#8203;<!-- 33 -->[core] Rename packages (#28049) @mnajdova

  replace `@material-ui/*` prefix with `@temp-mui/*`:

  ```bash
  @material-ui/system -> @temp-mui/system
  @material-ui/styles -> @temp-mui/styles
  @material-ui/lab -> @temp-mui/lab
  @material-ui/types -> @temp-mui/types
  @material-ui/styled-engine -> @temp-mui/styled-engine
  @material-ui/styled-engine-sc ->@temp-mui/styled-engine-sc
  @material-ui/private-theming -> @temp-mui/private-theming
  @material-ui/codemod -> @temp-mui/codemod
  ```

  except these 3 packages that are renamed.

  ```bash
  @material-ui/core => @temp-mui/material        // represents Material Design components.
  @material-ui/icons => @temp-mui/icons-material // represents Material Design icons.
  @material-ui/unstyled => @temp-mui/base        // fully functional components with minimum styles.
  ```

  > **Note**: `@temp-mui/base` (previously `@material-ui/unstyled`) is not the same as `@material-ui/core`.
...
- [docs] Mention @temp-muiContrib in CONTRIBUTING (#21891) @eps1lon
