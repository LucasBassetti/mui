...
@@ -61,7 +61,7 @@
   "dependencies": {
     "@babel/runtime": "^7.4.4",
     "@temp-mui/styled-engine": "^5.0.0-alpha.16",
-    "@temp-mui/material": "^5.0.0-alpha.15",
+    "@temp-mui/material": "https://pkg.csb.dev/mui/material-ui/commit/371c952b/@temp-mui/material",
     "@temp-mui/system": "^5.0.0-alpha.16",
```
...
The following example shows how to package `@temp-mui/material`, but you can package any npm package with this process:
