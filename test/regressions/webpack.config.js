...
module.exports = {
  ...
  plugins: [
    ...
    // Avoid bundling the whole @temp-mui/icons-material package. x2 the bundling speed.
  ...
  module: {
    rules: [
      {
        test: /\.(js|ts|tsx)$/,
        // prism.js blocks @temp-mui/internal-markdown/prism from being interpreted as ESM in this build.
