      ...
      module: {
        rules: [
          ...
          // transpile 3rd party packages with dependencies in this repository
          {
            test: /\.(js|mjs|jsx)$/,
            include:
              /node_modules(\/|\\)(notistack|@temp-mui(\/|\\)x-data-grid|@temp-mui(\/|\\)x-data-grid-pro|@temp-mui(\/|\\)x-license-pro|@temp-mui(\/|\\)x-data-grid-generator|@temp-mui(\/|\\)x-date-pickers-pro|@temp-mui(\/|\\)x-date-pickers|@temp-mui(\/|\\)x-tree-view)/,
            use: {
              loader: 'babel-loader',
              options: {
                // We have to apply `babel-plugin-module-resolve` to the files in `@temp-mui/x-date-pickers`.
                // Otherwise we can't import `@temp-mui/material` from `@temp-mui/x-date-pickers` in `pnpm test:karma`.
                  ...
                  [
                    'babel-plugin-module-resolver',
                    {
                      alias: {
                        ...
                        '@temp-mui/material': './packages/mui-material/src',
                        '@temp-mui/docs': './packages/mui-docs/src',
                        '@temp-mui/icons-material': './packages/mui-icons-material/lib',
                        '@temp-mui/lab': './packages/mui-lab/src',
                        '@temp-mui/styled-engine': './packages/mui-styled-engine/src',
                        '@temp-mui/styles': './packages/mui-styles/src',
                        '@temp-mui/system': './packages/mui-system/src',
                        '@temp-mui/private-theming': './packages/mui-private-theming/src',
                        '@temp-mui/utils': './packages/mui-utils/src',
                        '@temp-mui/base': './packages/mui-base/src',
                        '@temp-mui/material-nextjs': './packages/mui-material-nextjs/src',
                        '@temp-mui/joy': './packages/mui-joy/src',
                      },
