...
async function rewriteImportPaths(declarationFile, publishDir) {
  ...
  while ((importTypeMatch = importTypeRegExp.exec(code)) !== null) {
    ...
    // In filesystem semantics `@temp-mui/material` is a relative path.
