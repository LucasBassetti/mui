...
import {
  ...
  fixLineEndings,
  getUnstyledFilename,
} from '@temp-mui/internal-docs-utils';
import {
  getPropTypesFromFile,
  injectPropTypesInFile,
  InjectPropTypesInFileOptions,
} from '@temp-mui/internal-scripts/typescript-to-proptypes';
import {
  createTypeScriptProjectBuilder,
  TypeScriptProject,
} from '@temp-mui-internal/api-docs-builder/utils/createTypeScriptProject';
