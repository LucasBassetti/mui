...
function createWebpackConfig(entry, environment) {
  ...
  const configuration = {
    ...
    resolve: {
      alias: {
        '@temp-mui/material': path.join(workspaceRoot, 'packages/mui-material/build'),
        '@temp-mui/lab': path.join(workspaceRoot, 'packages/mui-lab/build'),
        '@temp-mui/styled-engine': path.join(workspaceRoot, 'packages/mui-styled-engine/build'),
        '@temp-mui/styled-engine-sc': path.join(workspaceRoot, 'packages/mui-styles-sc/build'),
        '@temp-mui/styles': path.join(workspaceRoot, 'packages/mui-styles/build'),
        '@temp-mui/system': path.join(workspaceRoot, 'packages/mui-system/build'),
        '@temp-mui/private-theming': path.join(workspaceRoot, 'packages/mui-private-theming/build'),
        '@temp-mui/utils': path.join(workspaceRoot, 'packages/mui-utils/build'),
        '@temp-mui/base': path.join(workspaceRoot, 'packages/mui-base/build'),
        '@temp-mui/material-nextjs': path.join(workspaceRoot, 'packages/mui-material-nextjs/build'),
        '@temp-mui/joy': path.join(workspaceRoot, 'packages/mui-joy/build'),
      },
    },
