...
import { ErrorBoundary, act, createRenderer, fireEvent, screen } from '@temp-mui-internal/test-utils';
import { createTheme, ThemeProvider } from '@temp-mui/material/styles';
import MenuItem, { menuItemClasses } from '@temp-mui/material/MenuItem';
