...
/**
 * @deprecated will be removed in v5.beta, please use StyledEngineProvider from @temp-mui/material/styles instead
 */
export { StyledEngineProvider } from './styles';

export { unstable_composeClasses } from '@temp-mui/base/composeClasses';
