...
import { createRenderer, fireEvent } from '@temp-mui-internal/test-utils';
import FormControl from '@temp-mui/material/FormControl';
import { inputBaseClasses } from '@temp-mui/material/InputBase';
import MenuItem from '@temp-mui/material/MenuItem';
import { outlinedInputClasses } from '@temp-mui/material/OutlinedInput';
import TextField, { textFieldClasses as classes } from '@temp-mui/material/TextField';
