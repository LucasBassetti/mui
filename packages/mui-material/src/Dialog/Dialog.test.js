...
import Modal from '@temp-mui/material/Modal';
import Dialog, { dialogClasses as classes } from '@temp-mui/material/Dialog';
...
/**
 * @param {typeof import('@temp-mui-internal/test-utils').screen} view
 */
