...
} from '@temp-mui/system/styleFunctionSx';
import systemCreateTheme from '@temp-mui/system/createTheme';
...
function createTheme(options = {}, ...args) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    // TODO v6: Refactor to use globalStateClassesMapping from @temp-mui/utils once `readOnly` state class is used in Rating component.
    const stateClasses = [
      'active',
      'checked',
      'completed',
    ...
    if (!warnedOnce) {
      ...
      console.error(
        [
          ...
          '',
          "You should use `import { createTheme } from '@temp-mui/material/styles'`",
        ].join('\n'),
      );
    }
  }
