...
import { ponyfillGlobal } from '@temp-mui/utils';

/* Warning if there are several instances of @temp-mui/styles */
if (
  process.env.NODE_ENV !== 'production' &&
  process.env.NODE_ENV !== 'test' &&
  typeof window !== 'undefined'
) {
  ponyfillGlobal['__@temp-mui/styles-init__'] = ponyfillGlobal['__@temp-mui/styles-init__'] || 0;

  if (ponyfillGlobal['__@temp-mui/styles-init__'] === 1) {
    console.warn(
      [
        'It looks like there are several instances of `@temp-mui/styles` initialized in this application.',
  ...
  ponyfillGlobal['__@temp-mui/styles-init__'] += 1;
}
