...
import { act, createRenderer, fireEvent, screen, createMount } from '@temp-mui-internal/test-utils';
import { Tab } from '@temp-mui/base/Tab';
import { Tabs, tabsClasses as classes, TabsProps } from '@temp-mui/base/Tabs';
import { TabsList } from '@temp-mui/base/TabsList';
import { TabPanel } from '@temp-mui/base/TabPanel';
