...
import { act, createRenderer, createMount, fireEvent } from '@temp-mui-internal/test-utils';
import { Snackbar, snackbarClasses as classes } from '@temp-mui/base/Snackbar';
