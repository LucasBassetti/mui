...
/**
 * For internal usage in `@temp-mui/system` package
 */
...
// These are the same as the ones in @temp-mui/styled-engine
...
// adapter for compatibility with @temp-mui/styled-engine
