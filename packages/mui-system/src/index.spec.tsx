...
import { breakpoints, display, compose, spacing, style, styled as muiStyled } from '@temp-mui/system';
...
/**
 * Testing inference of TypeScript + styled-components + @temp-mui/system
 */
