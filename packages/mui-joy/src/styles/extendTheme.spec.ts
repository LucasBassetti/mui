...
import { AccordionOwnerState } from '@temp-mui/joy/Accordion';
import { AccordionGroupOwnerState } from '@temp-mui/joy/AccordionGroup';
import { AccordionSummaryOwnerState } from '@temp-mui/joy/AccordionSummary';
import { AccordionDetailsOwnerState } from '@temp-mui/joy/AccordionDetails';
import { AlertOwnerState } from '@temp-mui/joy/Alert';
import { AspectRatioOwnerState } from '@temp-mui/joy/AspectRatio';
import { AutocompleteOwnerState } from '@temp-mui/joy/Autocomplete';
import { AutocompleteListboxOwnerState } from '@temp-mui/joy/AutocompleteListbox';
import { AutocompleteOptionOwnerState } from '@temp-mui/joy/AutocompleteOption';
import { AvatarOwnerState } from '@temp-mui/joy/Avatar';
import { AvatarGroupOwnerState } from '@temp-mui/joy/AvatarGroup';
import { BadgeOwnerState } from '@temp-mui/joy/Badge';
import { BreadcrumbsOwnerState } from '@temp-mui/joy/Breadcrumbs';
import { ButtonOwnerState } from '@temp-mui/joy/Button';
import { CardOwnerState } from '@temp-mui/joy/Card';
import { CardContentOwnerState } from '@temp-mui/joy/CardContent';
import { CardCoverOwnerState } from '@temp-mui/joy/CardCover';
import { CardOverflowOwnerState } from '@temp-mui/joy/CardOverflow';
import { CheckboxOwnerState } from '@temp-mui/joy/Checkbox';
import { ChipOwnerState } from '@temp-mui/joy/Chip';
import { ChipDeleteOwnerState } from '@temp-mui/joy/ChipDelete';
import { CircularProgressOwnerState } from '@temp-mui/joy/CircularProgress';
import { ContainerProps } from '@temp-mui/joy/Container';
import { ScopedCssBaselineOwnerState } from '@temp-mui/joy/ScopedCssBaseline';
import { DialogActionsOwnerState } from '@temp-mui/joy/DialogActions';
import { DialogContentOwnerState } from '@temp-mui/joy/DialogContent';
import { DialogTitleOwnerState } from '@temp-mui/joy/DialogTitle';
import { DividerOwnerState } from '@temp-mui/joy/Divider';
import { DrawerOwnerState } from '@temp-mui/joy/Drawer';
import { FormControlOwnerState } from '@temp-mui/joy/FormControl';
import { FormHelperTextOwnerState } from '@temp-mui/joy/FormHelperText';
import { FormLabelOwnerState } from '@temp-mui/joy/FormLabel';
import { GridProps } from '@temp-mui/joy/Grid';
import { IconButtonOwnerState } from '@temp-mui/joy/IconButton';
import { InputOwnerState } from '@temp-mui/joy/Input';
import { LinkOwnerState } from '@temp-mui/joy/Link';
import { LinearProgressOwnerState } from '@temp-mui/joy/LinearProgress';
import { ListOwnerState } from '@temp-mui/joy/List';
import { ListDividerOwnerState } from '@temp-mui/joy/ListDivider';
import { ListSubheaderOwnerState } from '@temp-mui/joy/ListSubheader';
import { ListItemOwnerState } from '@temp-mui/joy/ListItem';
import { ListItemButtonOwnerState } from '@temp-mui/joy/ListItemButton';
import { ListItemContentOwnerState } from '@temp-mui/joy/ListItemContent';
import { ListItemDecoratorOwnerState } from '@temp-mui/joy/ListItemDecorator';
import { MenuOwnerState } from '@temp-mui/joy/Menu';
import { MenuButtonOwnerState } from '@temp-mui/joy/MenuButton';
import { MenuItemOwnerState } from '@temp-mui/joy/MenuItem';
import { MenuListOwnerState } from '@temp-mui/joy/MenuList';
import { ModalOwnerState } from '@temp-mui/joy/Modal';
import { ModalCloseOwnerState } from '@temp-mui/joy/ModalClose';
import { ModalDialogOwnerState } from '@temp-mui/joy/ModalDialog';
import { ModalOverflowOwnerState } from '@temp-mui/joy/ModalOverflow';
import { OptionOwnerState } from '@temp-mui/joy/Option';
import { RadioOwnerState } from '@temp-mui/joy/Radio';
import { RadioGroupOwnerState } from '@temp-mui/joy/RadioGroup';
import { SelectOwnerState } from '@temp-mui/joy/Select';
import { SheetOwnerState } from '@temp-mui/joy/Sheet';
import { SliderOwnerState } from '@temp-mui/joy/Slider';
import { SnackbarOwnerState } from '@temp-mui/joy/Snackbar';
import { StackProps } from '@temp-mui/joy/Stack';
import { StepperOwnerState } from '@temp-mui/joy/Stepper';
import { StepOwnerState } from '@temp-mui/joy/Step';
import { StepButtonOwnerState } from '@temp-mui/joy/StepButton';
import { StepIndicatorOwnerState } from '@temp-mui/joy/StepIndicator';
import { extendTheme } from '@temp-mui/joy/styles';
import { SvgIconOwnerState } from '@temp-mui/joy/SvgIcon';
import { SwitchOwnerState } from '@temp-mui/joy/Switch';
import { TabOwnerState } from '@temp-mui/joy/Tab';
import { TabListOwnerState } from '@temp-mui/joy/TabList';
import { TabPanelOwnerState } from '@temp-mui/joy/TabPanel';
import { TabsOwnerState } from '@temp-mui/joy/Tabs';
import { TableOwnerState } from '@temp-mui/joy/Table';
import { TextareaOwnerState } from '@temp-mui/joy/Textarea';
import { ToggleButtonGroupOwnerState } from '@temp-mui/joy/ToggleButtonGroup';
import { TooltipOwnerState } from '@temp-mui/joy/Tooltip';
import { TypographyOwnerState } from '@temp-mui/joy/Typography';
