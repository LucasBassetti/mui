...
import { act, createRenderer, fireEvent } from '@temp-mui-internal/test-utils';
import { unstable_capitalize as capitalize } from '@temp-mui/utils';
import Link, { LinkClassKey, linkClasses as classes } from '@temp-mui/joy/Link';
import Typography from '@temp-mui/joy/Typography';
import { ThemeProvider, TypographySystem } from '@temp-mui/joy/styles';
