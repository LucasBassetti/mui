...
import { createRenderer, fireEvent, screen } from '@temp-mui-internal/test-utils';
import { ThemeProvider } from '@temp-mui/joy/styles';
import Accordion from '@temp-mui/joy/Accordion';
import AccordionSummary from '@temp-mui/joy/AccordionSummary';
import AccordionDetails, { accordionDetailsClasses as classes } from '@temp-mui/joy/AccordionDetails';
