...
import { ThemeProvider, CssVarsProvider, extendTheme, PalettePrimary } from '@temp-mui/joy/styles';
import { unstable_ClassNameGenerator as ClassNameGenerator } from '@temp-mui/joy/className';
