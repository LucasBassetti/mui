...
import { elementAcceptingRef, HTMLElementType } from '@temp-mui/utils';
import { unstable_composeClasses as composeClasses } from '@temp-mui/base/composeClasses';
import { Portal } from '@temp-mui/base/Portal';
import { FocusTrap } from '@temp-mui/base/FocusTrap';
import { unstable_useModal as useModal } from '@temp-mui/base/unstable_useModal';
