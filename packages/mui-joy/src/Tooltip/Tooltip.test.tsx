...
import { createRenderer, act } from '@temp-mui-internal/test-utils';
import { unstable_capitalize as capitalize } from '@temp-mui/utils';
import { PopperProps } from '@temp-mui/base';
import { ThemeProvider } from '@temp-mui/joy/styles';
import Tooltip, { tooltipClasses as classes, TooltipClassKey } from '@temp-mui/joy/Tooltip';
