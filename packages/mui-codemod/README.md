...
[![npm version](https://img.shields.io/npm/v/@temp-mui/codemod.svg?style=flat-square)](https://www.npmjs.com/package/@temp-mui/codemod)
[![npm downloads](https://img.shields.io/npm/dm/@temp-mui/codemod.svg?style=flat-square)](https://www.npmjs.com/package/@temp-mui/codemod)
...
```bash
npx @temp-mui/codemod@latest <codemod> <paths...>

Applies a `@temp-mui/codemod` to the specified paths
...
Examples:
  npx @temp-mui/codemod@latest v4.0.0/theme-spacing-api src
  npx @temp-mui/codemod@latest v5.0.0/component-rename-prop src --
  --component=Grid --from=prop --to=newProp
  npx @temp-mui/codemod@latest v5.0.0/preset-safe src --parser=flow
```
...
```bash
npx @temp-mui/codemod@latest --jscodeshift="--run-in-band --verbose=2"
```
...
```bash
npx @temp-mui/codemod@latest <transform> <path> --jscodeshift="--printOptions='{\"quote\":\"double\"}'"
```
...
```bash
npx @temp-mui/codemod@latest deprecations/all <path>
```
...
```bash
npx @temp-mui/codemod@latest deprecations/accordion-props <path>
```
...
```diff
 import { accordionSummaryClasses } from '@temp-mui/material/AccordionSummary';
...
```bash
npx @temp-mui/codemod@latest deprecations/accordion-summary-classes <path>
```
...
```diff
 import { alertClasses } from '@temp-mui/material/PaginationItem';
...
```bash
npx @temp-mui/codemod@latest deprecations/alert-classes <path>
```
...
```bash
npx @temp-mui/codemod@latest deprecations/alert-props <path>
```
...
```diff
 import { buttonClasses } from '@temp-mui/material/Button';
...
```bash
npx @temp-mui/codemod@latest deprecations/button-classes <path>
```
...
```diff
 ...
 import { chipClasses } from '@temp-mui/material/Chip';
...
```bash
npx @temp-mui/codemod@latest deprecations/chip-classes <path>
```
...
```bash
npx @temp-mui/codemod@latest deprecations/divider-props <path>
```
...
```diff
 import { paginationItemClasses } from '@temp-mui/material/PaginationItem';
...
```bash
npx @temp-mui/codemod@latest deprecations/pagination-item-classes <path>
```
...
```bash
npx @temp-mui/codemod@latest deprecations/slider-props <path>
```
...
```diff
-import BaseButton from '@temp-mui/base/Button';
-export { default as BaseSlider } from '@temp-mui/base/Slider';
+import { Button as BaseButton } from '@temp-mui/base/Button';
+export { Slider as BaseSlider } from '@temp-mui/base/Slider';
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/rename-css-variables <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/base-hook-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/joy-rename-classname-prefix <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/joy-rename-row-prop <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/joy-avatar-remove-imgProps <path>
```
...
```diff
-import TextField from '@temp-mui/joy/TextField';
+import FormControl from '@temp-mui/joy/FormControl';
+import FormLabel from '@temp-mui/joy/FormLabel';
+import FormHelperText from '@temp-mui/joy/FormHelperText';
...
```bash
npx @temp-mui/codemod@latest v5.0.0/joy-text-field-to-input <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/joy-rename-components-to-slots <path>
```
...
Rename the imports of Date and Time Pickers from `@temp-mui/lab` to `@temp-mui/x-date-pickers` and `@temp-mui/x-date-pickers-pro`.

```bash
npx @temp-mui/codemod@latest v5.0.0/date-pickers-moved-to-x <path>
```

#### `tree-view-moved-to-x`

Rename the imports of Tree View from `@temp-mui/lab` to `@temp-mui/x-tree-view`.

```bash
npx @temp-mui/codemod@latest v5.0.0/tree-view-moved-to-x <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/preset-safe <path|folder>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/adapter-v4 <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/autocomplete-rename-closeicon  <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/autocomplete-rename-option  <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/avatar-circle-circular <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/badge-overlap-value <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/base-rename-components-to-slots <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/box-borderradius-values <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/box-rename-css <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/box-rename-gap <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/button-color-prop <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/chip-variant-prop <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/circularprogress-variant <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/collapse-rename-collapsedheight <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/component-rename-prop <path> -- --component=Grid --from=prop --to=newProp
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/core-styles-import <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/create-theme <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/dialog-props <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/dialog-title-props <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/expansion-panel-component <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/fab-variant <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/fade-rename-alpha <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/grid-justify-justifycontent <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/grid-list-component <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/icon-button-size <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/jss-to-styled <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/jss-to-tss-react <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/link-underline-hover <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/material-ui-styles <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/material-ui-types <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/modal-props <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/moved-lab-modules <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/pagination-round-circular <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/optimal-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/root-ref <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/skeleton-variant <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/styled-engine-provider <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/table-props <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/tabs-scroll-buttons <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/textarea-minmax-rows <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-augment <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-breakpoints <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-breakpoints-width <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-options <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-palette-mode <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-provider <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-spacing <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/theme-typography-round <path>
```
...
Converts all `@temp-mui/material` submodule imports to the root module:

```diff
-import List from '@temp-mui/material/List';
-import Grid from '@temp-mui/material/Grid';
+import { List, Grid } from '@temp-mui/material';
```

<!-- #default-branch-switch -->

```bash
npx @temp-mui/codemod@latest v5.0.0/top-level-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/transitions <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/use-autocomplete <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/use-transitionprops <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/variant-prop <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/with-mobile-dialog <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/with-width <path>
```
...
```bash
npx @temp-mui/codemod@latest v5.0.0/mui-replace <path>
```
...
```bash
npx @temp-mui/codemod@latest v4.0.0/theme-spacing-api <path>
```
...
```bash
npx @temp-mui/codemod@latest v4.0.0/optimal-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v4.0.0/top-level-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v1.0.0/import-path <path>
```
...
```bash
npx @temp-mui/codemod@latest v1.0.0/color-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v1.0.0/color-imports <path> -- --importPath='mui/styles/colors' --targetPath='mui/colors'
```
...
```bash
npx @temp-mui/codemod@latest v1.0.0/svg-icon-imports <path>
```
...
```bash
npx @temp-mui/codemod@latest v1.0.0/menu-item-primary-text <path>
```
...
```bash
npx @temp-mui/codemod@latest v0.15.0/import-path <path>
```
