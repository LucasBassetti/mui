...
import ToggleButton from '@temp-mui/material/ToggleButton';
  ...
  if (!warnedOnce) {
    console.warn(
      [
        ...
        '',
        "You should use `import { ToggleButton } from '@temp-mui/material'`",
        "or `import ToggleButton from '@temp-mui/material/ToggleButton'`",
      ].join('\n'),
    );
