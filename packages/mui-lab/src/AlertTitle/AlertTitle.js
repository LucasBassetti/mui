...
import AlertTitle from '@temp-mui/material/AlertTitle';
  ...
  if (!warnedOnce) {
    console.warn(
      [
        ...
        '',
        "You should use `import { AlertTitle } from '@temp-mui/material'`",
        "or `import AlertTitle from '@temp-mui/material/AlertTitle'`",
      ].join('\n'),
    );
