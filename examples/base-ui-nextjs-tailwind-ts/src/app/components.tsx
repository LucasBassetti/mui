...
import {
  ...
  SelectOwnerState,
  SelectRootSlotProps,
} from '@temp-mui/base/Select';
import { Option, OptionProps, OptionOwnerState } from '@temp-mui/base/Option';
import { Slider as BaseSlider, SliderProps, SliderOwnerState } from '@temp-mui/base/Slider';
