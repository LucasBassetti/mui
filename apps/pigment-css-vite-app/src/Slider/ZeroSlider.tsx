...
import { unstable_composeClasses as composeClasses } from '@temp-mui/utils';
import {
  type SliderOwnerState,
  type SliderProps,
  sliderClasses,
  getSliderUtilityClass,
} from '@temp-mui/material/Slider';
import { isHostComponent, useSlotProps } from '@temp-mui/base/utils';
import { styled } from '@pigment-css/react';
import { capitalize } from '@temp-mui/material/utils';
import SliderValueLabel from '@temp-mui/material/Slider/SliderValueLabel';
import { useSlider, valueToPercent } from '@temp-mui/base/useSlider';
import { alpha, lighten, darken } from '@temp-mui/system/colorManipulator';
import type { Theme } from '@temp-mui/material/styles';
