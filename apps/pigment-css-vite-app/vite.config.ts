...
export default defineConfig({
  plugins: [
    ...
    pigment({
      theme,
      transformLibraries: ['local-ui-lib', '@temp-mui/material'],
      sourceMap: true,
      displayName: true,
      transformSx: false,
    }),
  ...
  resolve: {
    alias: [
      {
        find: /^@temp-mui\/system\/(.*)/,
        replacement: '@temp-mui/system/esm/$1',
      },
      {
        find: /^@temp-mui\/icons-material\/(.*)/,
        replacement: '@temp-mui/icons-material/esm/$1',
      },
    ],
  },
});
